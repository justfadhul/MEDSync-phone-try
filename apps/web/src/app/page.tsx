...
const PORTRAITS = [
  { src: "/welcome/portrait-1.jpg", alt: "Illustrative portrait — a Ugandan doctor", cls: "z-10 mt-5 h-56 w-24 sm:h-64 sm:w-28" },
  { src: "/welcome/portrait-2.jpg", alt: "Illustrative portrait — a Ugandan nurse", cls: "z-20 h-60 w-24 sm:h-72 sm:w-28" },
  { src: "/welcome/portrait-3.jpg", alt: "Illustrative portrait — a community health worker", cls: "z-10 mt-10 h-52 w-24 sm:h-60 sm:w-28" },
];
